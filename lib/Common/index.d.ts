...
export type CallbackFunction = (err: ErrorStringOrUndefinedOrNull, result?: unknown) => void;
...
export type HandlerFunction = (body: unknown, data: IEnvironmentData & IHeaderData, callback: CallbackFunction) => PromiseLike<unknown> | unknown;
export declare function isHandlerFunction(value: unknown): value is HandlerFunction;
